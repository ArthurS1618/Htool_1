...
class LowRankMatrix : public VirtualBlockData<T> {
  ...
  public:
	...
	//JE rajoute ca
  LowRankMatrix(const Matrix<T> U0, const Matrix<T> V0): U(U0), V(V0) {}
  ...
  //void set_U(const Matrix<double> &U0) U(U0){}
    ...
    //Je rajoute des get pour pouvoir avoir U et V d'un coup
  Matrix<T> Get_U()const{return this->U;}
  Matrix<T> Get_V()const{return this->V;}
  // je rejoute aussi la multplication lrmat lrmat
  // LowRankMatrix<T>
